...
<div class="card card-default">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button class="btn btn-sm btn-flat btn-success" id="print" type="button"><i class="fa fa-print"></i> 인쇄</button>
            <a class="btn btn-sm btn-flat btn-primary" href="?page=purchase_orders/manage_po&id=<?php echo $id ?>">수정</a>
            <a class="btn btn-sm btn-flat btn-default" href="?page=purchase_orders">뒤로</a>
        </div>
    </div>
    <div class="card-body" id="out_print">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <h2 class="text-center"><b>구매 주문서</b></h2>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
                <p class="m-0"><b>공급업체</b></p>
                <?php
            ...
            <div class="col-6 row">
                <div class="col-6">
                    <p  class="m-0"><b>주문번호:</b></p>
                    <p><b><?php echo $po_no ?></b></p>
                </div>
                <div class="col-6">
                    <p  class="m-0"><b>생성일</b></p>
            ...
            <div class="col-md-12">
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tr class="bg-navy disabled" style="">
                        <th class="bg-navy disabled text-light px-1 py-1 text-center">수량</th>
                        <th class="bg-navy disabled text-light px-1 py-1 text-center">단위</th>
                        <th class="bg-navy disabled text-light px-1 py-1 text-center">품목</th>
                        <th class="bg-navy disabled text-light px-1 py-1 text-center">설명</th>
                        <th class="bg-navy disabled text-light px-1 py-1 text-center">가격</th>
                        <th class="bg-navy disabled text-light px-1 py-1 text-center">합계</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    <tr>
                        <th class="p-1 text-right" colspan="5">소계</th>
                        <th class="p-1 text-right" id="sub_total"><?php echo number_format($sub_total) ?></th>
                    </tr>
                    <tr>
                        <th class="p-1 text-right" colspan="5">할인 (<?php echo isset($discount_percentage) ? $discount_percentage : 0 ?>%)
                        </th>
                        <th class="p-1 text-right"><?php echo isset($discount_amount) ? number_format($discount_amount) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="p-1 text-right" colspan="5">세금 포함 (<?php echo isset($tax_percentage) ? $tax_percentage : 0 ?>%)</th>
                        <th class="p-1 text-right"><?php echo isset($tax_amount) ? number_format($tax_amount) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="p-1 text-right" colspan="5">총계</th>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        switch($status){
                            case 1:
                                echo "<span class='py-2 px-4 btn-flat btn-success'>승인됨</span>";
                                break;
                            case 2:
                                echo "<span class='py-2 px-4 btn-flat btn-danger'>거부됨</span>";
                                break;
                            default:
                                echo "<span class='py-2 px-4 btn-flat btn-secondary'>대기중</span>";
                                break;
                        }
                        ?>
                    </div>
